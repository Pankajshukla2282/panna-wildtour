<?php
/**
 * Single plugin package template.
 *
    ...
    <?php while ( have_posts() ) : the_post(); ?>
        <article id="post-<?php the_ID(); ?>" <?php post_class( 'package-detail' ); ?>>
            ...
            <footer class="entry-footer">
                <a class="button" href="<?php echo esc_url( add_query_arg( 'package', get_the_ID(), panna_wildtour_get_page_url( 'booking' ) ) ); ?>"><?php esc_html_e( 'Book This Package', 'panna-wildtour' ); ?></a>
            </footer>
        </article>
    <?php endwhile; ?>
</main>
