<?php
/**
 * Archive plugin package template.
 *
...
<main id="content" class="site-main site-wrapper">
    <section class="section">
        <div class="section-header">
            ...
            <p><?php esc_html_e( 'Explore safari packages, wildlife tours, and stay combinations for Panna National Park and nearby circuits.', 'panna-wildtour' ); ?></p>
        </div>
